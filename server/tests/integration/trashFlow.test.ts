...
describe('Trash Flow Integration (Soft Delete -> Restore)', () => {
  it('should soft delete a customer and then restore it', async () => {
    ...
    const foundInList = listRes.body.find((c: any) => c._id === customerId);
    ...
    const foundInTrash = trashRes.body.find((c: any) => c._id === customerId);
    ...
    const foundInList2 = listRes2.body.find((c: any) => c._id === customerId);
