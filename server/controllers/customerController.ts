...
const getTrashedCustomers = asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private/Admin
const restoreCustomer = asyncHandler(async (req: Request, res: Response) => {
  const customer = await Customer.findById(req.params.id);
...
// @access  Private/Admin
const forceDeleteCustomer = asyncHandler(async (req: Request, res: Response) => {
  const customer = await Customer.findById(req.params.id);
