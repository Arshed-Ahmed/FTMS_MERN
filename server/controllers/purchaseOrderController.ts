...
// @access  Private
const getPurchaseOrders = asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private
const getPurchaseOrderById = asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private
const createPurchaseOrder = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
// @access  Private
const updatePurchaseOrderStatus = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
// @access  Private
const payPurchaseOrder = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
// @access  Private
const deletePurchaseOrder = asyncHandler(async (req: Request, res: Response) => {
  const order = await PurchaseOrder.findById(req.params.id);
...
// @access  Private
const getTrashedPurchaseOrders = asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private
const restorePurchaseOrder = asyncHandler(async (req: Request, res: Response) => {
  const order = await PurchaseOrder.findById(req.params.id);
  if (order) {
    await order.restore();
...
// @access  Private
const forceDeletePurchaseOrder = asyncHandler(async (req: Request, res: Response) => {
  const order = await PurchaseOrder.findById(req.params.id);
  if (order) {
