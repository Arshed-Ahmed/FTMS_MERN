...
// @access  Private
const createTransaction = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
const getFinancialSummary = asyncHandler(async (req: Request, res: Response) => {
  ...
  let dateFilter: any = { isDeleted: false };
...
// @access  Private
const getTrashedTransactions = asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private
const restoreTransaction = asyncHandler(async (req: Request, res: Response) => {
  const transaction = await Transaction.findById(req.params.id);
  if (transaction) {
...
// @access  Private
const forceDeleteTransaction = asyncHandler(async (req: Request, res: Response) => {
  const transaction = await Transaction.findById(req.params.id);
  if (transaction) {
