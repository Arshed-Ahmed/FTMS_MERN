...
// @access  Private
const getMaterials = asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private
const getMaterialById = asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private
const updateMaterial = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
  const {
    name,
    type,
    color,
...
// @access  Private
const adjustStock = asyncHandler(async (req: AuthenticatedRequest, res: Response) => {
...
// @access  Private
const deleteMaterial = asyncHandler(async (req: Request, res: Response) => {
  const material = await Material.findById(req.params.id);
...
// @access  Private
const getTrashedMaterials = asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private
const restoreMaterial = asyncHandler(async (req: Request, res: Response) => {
  const material = await Material.findById(req.params.id);
  if (material) {
...
// @access  Private
const forceDeleteMaterial = asyncHandler(async (req: Request, res: Response) => {
  const material = await Material.findById(req.params.id);
  if (material) {
