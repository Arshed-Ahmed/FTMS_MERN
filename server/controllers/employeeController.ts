...
const getTrashedEmployees = asyncHandler(async (req: Request, res: Response) => {
...
// @access  Private/Admin
const restoreEmployee = asyncHandler(async (req: Request, res: Response) => {
  const employee = await Employee.findById(req.params.id);
...
// @access  Private/Admin
const forceDeleteEmployee = asyncHandler(async (req: Request, res: Response) => {
  const employee = await Employee.findById(req.params.id);
