...
export const notifyOrderCreated = async (customer, order) => {
    // Email
...
export const notifyOrderStatusChange = async (customer, order, newStatus) => {
    // Email
...
export const notifyOrderReady = async (customer, order) => {
    // Email
...
export const notifyJobAssigned = async (tailorId, order) => {
