...
// @access  Private
const getTrashedSuppliers = asyncHandler(async (req, res) => {
...
// @access  Private
const forceDeleteSupplier = asyncHandler(async (req, res) => {
    const supplier = await Supplier.findById(req.params.id);
    if (supplier) {
...
export { getSuppliers, getSupplierById, createSupplier, updateSupplier, deleteSupplier, getTrashedSuppliers, restoreSupplier, forceDeleteSupplier, };
